...
import { createClient, type RealtimeChannel, type RealtimeChannelOptions } from '@supabase/supabase-js';
...
/**
 * Creates a unique Supabase Realtime channel instance.
 * Appends a unique random suffix to the channel name (unless exactTopic is true)
 * and removes any existing channel with the same name to prevent channel reuse collisions
 * that cause "cannot add callbacks after subscribe()" errors when components remount
 * or when multiple components subscribe to realtime events.
 */
