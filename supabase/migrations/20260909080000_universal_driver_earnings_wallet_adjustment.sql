-- Migration: Universal Driver Wallet Adjustment RPC & Schema Reload

-- 1. Ensure driver_earnings columns exist if needed
...
-- 2. Recreate admin_adjust_driver_wallet RPC to insert universal columns and audit log
...
BEGIN
  ...
  -- 7. Insert into driver_earnings using core fields
...
-- Overload signatures for parameter order variations
CREATE OR REPLACE FUNCTION public.admin_adjust_driver_wallet(
  p_driver_id text,
  p_operation text,
  p_amount numeric,
